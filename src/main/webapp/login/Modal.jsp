					...
					<div class="modal-content ">
						...
						<div class="modal-body">
							<form>
								...
								<div class="form-group">
									<label for="lead_name" class="h5 f-14">To Do Task</label> <select
										id="to_do_task"
										class="form-control to_do_task rounded-0 w-100"
										name="to_do_task">
										<option selected>Choose...</option>
										<option value="AL">Alabama</option>
										<option value="WY">Wyoming</option>
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="task_type" class="h5 f-14">Task Type</label> <select
											...
											<div style="word-wrap: break-word;">
												<option
													title="that accepts deposits from the public
                                          ...
                                          Basel Accords.">A
													bank is a financial institution that accepts deposits from
													the public and creates credit.[1] Lending activities can be
													performed either directly or indirectly through capital
													markets. Due to their importance in the financial stability
													of a country, banks are highly regulated in most countries.
													Most nations have institutionalized a system known as
													fractional reserve banking under which banks hold liquid
													assets equal to only a portion of their current
													liabilities. In addition to other regulations intended to
													ensure liquidity, banks are generally subject to minimum
													capital requirements based on an international set of
													capital standards, known as the Basel Accords.</option>
											</div>
									...
									<div class="form-group col-md-6">
										<label for="task_by" class="h5 f-14">Task By</label> <select
											name="select_taskby" multiple="multiple" id="select_taskby">
											<option value="AL">Alabama</option>
